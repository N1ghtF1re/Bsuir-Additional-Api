package men.brakh.bsuirapi.inrfastructure.schedulers
...
object LessonsScheduleUpdater {
    ...
    private val bsuirApi = Config.bsuirApi
    ...
    private fun updateDb() {
        ...
        val lessonsRepo = MysqlLessonRepository("_tmp_lessons_", Config.auditoriumRepository)
