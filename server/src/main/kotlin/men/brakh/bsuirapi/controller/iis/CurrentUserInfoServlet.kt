...
class CurrentUserInfoServlet: HttpServletWithErrorHandling(), JsonServlet {
    override fun doGet(req: HttpServletRequest, resp: HttpServletResponse) {

        authorized(req) { user ->
            resp.writeJson(BsuirApi.getPersonalCV(authorizedUserAuthorizationRequest = user).toUserInfoObject())
        }
    }
}