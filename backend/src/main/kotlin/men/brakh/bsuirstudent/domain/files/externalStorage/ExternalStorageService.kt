package men.brakh.bsuirstudent.domain.files.externalStorage
...
interface ExternalFilesStorageService {
     ...
     */
    fun getFile(fileExternalId: String): ByteArray
     ...
     */
    fun uploadFile(filename: String, inputStream: InputStream, contentType: String): UploadedFileDto
